...
export default function Home() {
  ...
  useEffect(() => {
    // You can add auth/session checks here later
    setLoading(false);
  }, []);
      ...
      <main className="px-6 pt-12 pb-20">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-gray-500 text-lg mb-8">
            Stop wasting time visiting multiple pharmacies. Find out which
            nearby pharmacy has your medicine in stock.
          </p>
        ...
        <section className="mt-16 max-w-lg mx-auto bg-gray-50 rounded-2xl p-6">
          ...
          <ul className="space-y-2 text-gray-600">
            ...
            <li className="flex items-center gap-2">
              ...
              <span>
                No delivery obligation — customers visit you
              </span>
            </li>
          </ul>
        </section>
